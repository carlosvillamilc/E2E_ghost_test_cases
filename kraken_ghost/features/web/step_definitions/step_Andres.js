...
Then('I enter  entre new post content {kraken-string}', async function (content) {
    let element = await this.driver.$('[data-placeholder="Begin writing your post..."]')
    return await element.setValue(content);
});

Then('I click on Publish option', async function(){
    let element = await this.driver.$('#ember641')
    return await element.click();
});

Then('I click on Drafts', async function(){
    let element = await this.driver.$('#ember920')
    return await element.click();
});

Then('I enter to first draft', async function(){
...
Then('I enter to first published', async function(){
...
Then('I click on Update option', async function(){
...
Then('I click on Scheduled', async function(){
    let element = await this.driver.$('#ember2300')
    return await element.click();
});

Then('I click on Scheduled New post', async function(){
